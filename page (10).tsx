...
const cluster = clusters.find((c) => c.id === "discovery-and-purpose")!;
...
export default function ClusterPage() {
  const clusterServices = getServicesByCluster("discovery-and-purpose");
  return (
    <main>
      <SiteHeader />
            ...
            <div className="service-cards">
              {clusterServices.map((service) => (
                <div className="service-card" key={service.slug}>
                  ...
                  <Link href={`/discovery-and-purpose/${service.slug}`}>
