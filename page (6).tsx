...
const cluster = clusters.find((c) => c.id === "legacy-and-documents")!;
...
export default function ClusterPage() {
  const clusterServices = getServicesByCluster("legacy-and-documents");
  return (
    <main>
      <SiteHeader />
            ...
            <div className="service-cards">
              {clusterServices.map((service) => (
                <div className="service-card" key={service.slug}>
                  ...
                  <Link href={`/legacy-and-documents/${service.slug}`}>
